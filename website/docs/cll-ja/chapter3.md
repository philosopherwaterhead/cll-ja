...
強調には、1次強調 "primaly stress"、2次強調 "secondary stress"、弱強調 "weak stress" の3段階がある。  
弱強調は最低レベルの強調であり、全く強調がないことを意味する。弱強調は `y` や音節子音、または緩衝母音に必要である。  
  
ロジバンの内容語（ブリヴラと呼ばれる）の後ろから2番目の音節は、1次強調が必要である。  
ロジバン化された名前はどの音節も強調される可能性があるが、後ろから2番目以外の音節が強調される場合、  
その音節（または、少なくともその母音）は大文字で書く必要がある。  
ロジバンの構造語（シマヴォ）は、どの音節も強調されるか、全く強調されない場合がある。  
ただし、休止で区切られない限り、ブリヴラの直前の音節で1次強調をかけることはできない。  
さもなければ、2つの単語が一緒に読まれる可能性がある。  
  
2次強調は、弱強調または1次強調のいずれかが必要な音節に加えて、それ以外の音節に使用される、任意の非示唆的な強調である。  
2次強調を規定する規則はほとんど無く、通常は話し手の母語習慣や好みに従う。2次強調は、文脈や概念の強調に使用することが出来る。  
2次強調は、1次強調までのどの音節も強調することができるが、単語の誤解が生じる可能性があるため、話し手の誤った1次強調を許可しない。  
