...
それらの2つの性質を合わせて、専門的な用語で "_audio-visual isomorphism_" と呼んでいる。  
...
ロジバンの発音は、国際音声記号（International Phonetic Alphabet, IPA）という、標準的な発音記号の転写方法で定義されている。  
...
ロジバンの音は、間違えられないようにはっきり発音する必要がある。  
正しく発音するためには、発声と舌の位置が重要だが、ロジバンのコミュニティでは、子音間の微妙な差異が生じる。  
現時点の発音に関する必須規則はこれだけである。  
  
特に、ロジバンの母音は唇を丸めて発音することも、丸めずに発音することもできる。  
通常、`o` と `u` は唇が丸められ、その他は丸めないが、`y` を丸める人もいる（必須条件ではない）。  
ロジバンの子音は、有気音にも無気音にもすることができる。  
ロシア語などに見られる子音の口蓋化は、標準的な発音では認められないが、後続の `i` が原因で発生することがある。 
...
ロジバンでは、これらは共に母音を介さずに話される子音とみなされるため、tc (IPA [tʃ]) と dj (IPA [dʒ]) という2つの異なる子音で表現される。  
