...
大抵は、話し手と聞き手、当人同士が指摘できること以外の会話がしたいだろうと思われる。  
他人と会話をする場合、自分が話したいことは当然、tavlaの最初の位置に当てはまる。  
ロジバンには、セルブリから最初の場所を引き出し、描写スムティ "_description sumti_"と呼ばれるスムティに変換するオペレーターがある。  
